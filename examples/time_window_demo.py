...
print(
    f"⏰ Monitoring Started: {monitoring_start.strftime('%H:%M:%S')} (30 seconds ago)"
)
...
print(
    f"      Rate: {total_5min_volume / 300:.1f} contracts/sec, {total_5min_trades / 300:.2f} trades/sec"
)
...
print(
    f"      Rate: {monitoring_volume / 30:.1f} contracts/sec, {monitoring_trades / 30:.2f} trades/sec"
)
